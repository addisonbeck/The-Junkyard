...
Partial Public Class StudentsClassSetDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.BeckChapter7Lab.My.MySettings.Default.CourseRegistrationConnectionString, mappingSource)
		OnCreated
	End Sub
